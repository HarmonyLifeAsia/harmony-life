# Mail powitalny — lead ze strony /film (VSL)

Do wklejenia w Make.com (moduł Email / Gmail) jako autoresponder po zapisie leada.
Zmienne z webhooka: `{{name}}`, `{{phone}}`, `{{email}}`.

---

**Od:** Robert Szymański — Harmony Life <robert@harmonylife.asia>
**Temat:** {{name}}, Twoje materiały o willach na Koh Samui 🌴

---

Cześć {{name}},

dzięki za obejrzenie filmu i zostawienie kontaktu — to ja, Robert z Harmony Life.

Mieszkam na Koh Samui i buduję tu wille dla polskich inwestorów — w europejskich
standardach i w legalnej strukturze opartej o rekomendacje tajskiego rządu.

**Co teraz?**

1. **Odezwę się do Ciebie na WhatsApp** (jeśli jeszcze nie piszemy) — zwykle w ciągu
...
3. **Jedno ważne zastrzeżenie** — wszystkie liczby, które pokazuję, to prognozy
   ...
   model tak, żebyś mógł sam ocenić założenia.

Do usłyszenia,

**Robert Szymański**
Założyciel Harmony Life · Koh Samui
