...
function Stat({ numeric, suffix, label, delay }: StatProps) {
  ...
  // Show the final value immediately (no count-up from 0) so a slow link or
  // disabled JS never renders "0".
  return (
    <motion.div
      ref={ref}
    ...
    >
      <p className="font-serif text-4xl md:text-5xl text-gradient-gold">{numeric}{suffix}</p>
