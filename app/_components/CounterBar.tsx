...
const stats = [
  { numeric: 5, suffix: '', label: 'Active Developments' },
  { numeric: 20, suffix: '+', label: 'Years Experience' },
  { numeric: 150, suffix: '+', label: 'Projects in Europe' },
  { numeric: 100, suffix: '%', label: 'European Build Standards' },
]
...
function Stat({ numeric, suffix, label, delay }: StatProps) {
  ...
  return (
    ...
    >
      <p className="font-serif text-4xl md:text-5xl text-gradient-gold">
        {count}{suffix}
      </p>
