        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: nav.bookConsultation, href: `/${lang}/contact` },
              ].map(({ label, href }) => (
                <li key={label}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="mailto:info@harmonylife.asia" className="text-cream/50 hover:text-gold text-sm transition-colors cursor-pointer">info@harmonylife.asia</a></li>
              <li><a href="https://wa.me/66000000000" className="text-cream/50 hover:text-gold text-sm transition-colors cursor-pointer">WhatsApp</a></li>
            </ul>
            <div className="mt-8">
