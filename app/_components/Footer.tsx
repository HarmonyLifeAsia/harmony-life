...
import { CONTACT_EMAIL, CALENDLY_URL, bookingHref } from '../_data/site'
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href={bookingHref(lang)} target={bookingHref(lang).startsWith('http') ? '_blank' : undefined} rel="noopener noreferrer" className="text-cream/50 hover:text-gold text-sm transition-colors duration-200 cursor-pointer">
                  {nav.bookStay}
                </a>
              </li>
            </ul>
