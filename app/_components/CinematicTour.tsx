  ...
  return (
    <section ref={containerRef} className="relative" style={{ height: '300vh' }}>
      <div className="sticky top-0 h-screen overflow-hidden bg-primary">
        <motion.div style={{ opacity: s1Opacity, scale: s1Scale }} className="absolute inset-0 will-change-transform">
          <img src={scenes[0].image} alt={scenes[0].alt} className="w-full h-full object-cover" />
        </motion.div>
        <motion.div style={{ opacity: s2Opacity, scale: s2Scale }} className="absolute inset-0 will-change-transform">
          <img src={scenes[1].image} alt={scenes[1].alt} className="w-full h-full object-cover" />
        </motion.div>
        <motion.div style={{ opacity: s3Opacity, scale: s3Scale }} className="absolute inset-0 will-change-transform">
