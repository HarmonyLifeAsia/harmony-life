          ...
          >
            {navLinks.map((link, i) => (
              ...
              >
                <Link
                  ...
                  className="font-serif text-3xl text-cream hover:text-gold transition-colors duration-200 cursor-pointer"
                >
                  {link.label}
                </Link>
              </motion.div>
            ...
            >
              <Link
                href="/contact"
                onClick={() => setMenuOpen(false)}
                className="border border-gold text-gold px-8 py-3 text-sm tracking-widest uppercase cursor-pointer"
              >
                Book Consultation
              </Link>
            </motion.div>
