...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: 'SOLAYA is a new Harmony Life villa project in the prestigious Plai Laem district of Koh Samui: 2–3 bedroom villas, including a flagship type with a private rooftop terrace. Every villa has a sea or panoramic view, a private pool and tropical garden. European build quality, a leasehold structure registered with the Land Department, and full rental management by one team — from construction to quarterly settlements.',
    type: 'Villas',
    bedrooms: '2–3 BR',
    bathrooms: '2–3',
