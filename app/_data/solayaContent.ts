...
const pl: SolayaCopy = {
  ...
  villas: {
    ...
    types: [
      { key: '2bed', name: 'Willa 2 sypialnie', area: '194–249 m² powierzchni użytkowej', tagline: 'Kompaktowy luksus', desc: 'Zaprojektowana pod wynajem premium: otwarta strefa dzienna z kuchnią i jadalnią, dwie sypialnie z łazienkami, prywatny basen i przestronny taras. Idealna dla par i małych rodzin — i najłatwiejsza w wynajmie.', features: ['Otwarta strefa dzienna', 'Dwie sypialnie z łazienkami', 'Prywatny basen i taras'] },
      { key: '3bed', name: 'Willa 3 sypialnie', area: '282–342 m² powierzchni użytkowej', tagline: 'Przestrzeń dla rodziny i gości', desc: 'Otwarty salon z wyspą kuchenną i jadalnią, trzy sypialnie z łazienkami, basen i taras w standardzie resortowym, dom otwarty na ogród. Wysoka atrakcyjność najmu w segmencie rodzinnym i grupowym.', features: ['Salon z wyspą kuchenną', 'Trzy sypialnie z łazienkami', 'Taras i basen resortowy'] },
      { key: 'terrace', name: 'Willa 3 sypialnie + taras na dachu', area: '279–315 m² powierzchni użytkowej', tagline: 'Typ flagowy', desc: 'Wszystko, co ma wersja 3-sypialniowa, plus prywatny taras na dachu ze strefą lounge i jadalnią pod pergolą oraz panoramicznym widokiem na morze. Zachody słońca na własnym dachu to atut, dla którego goście wracają.', features: ['Prywatny taras na dachu', 'Lounge i jadalnia pod pergolą', 'Panoramiczny widok na morze'] },
    ],
  },
  finishing: {
  ...
  roi: {
    ...
    title: '15–19% zwrotu netto — w zależności od willi',
    intro: 'Wartości netto — po kosztach operacyjnych i wynagrodzeniu operatora. Stawki najmu odpowiadają realnym cenom porównywalnych willi w Plai Laem (oferty Booking.com). Zwrot różni się między grupami willi, bo zależy od położenia, liczby sypialni i ceny. Prognoza, nie gwarancja.',
    revenueLabel: 'Przychód brutto / rok',
    netLabel: 'Zysk netto / rok',
    rateLabel: 'Zwrot netto',
    rateNote: 'średnia z widełek bazowy–górny',
    villas: [
      { name: 'Wille 1–3 · 3 sypialnie', revenue: '4,5–4,9 mln THB', net: '2,7–3,0 mln THB', rate: '16,2%' },
      { name: 'Wille 4–9 · 2 sypialnie', revenue: '3,5–3,8 mln THB', net: '2,0–2,2 mln THB', rate: '15,2%' },
      { name: 'Wille 10–15 · 2–3 syp. + taras', revenue: '3,4–3,8 mln THB', net: '2,0–2,2 mln THB', rate: '16,1%' },
      { name: 'Wille 16–19 · 3 syp. + taras', revenue: '3,9–4,3 mln THB', net: '2,3–2,5 mln THB', rate: '18,8%' },
    ],
    ...
    costs: ['Koszty stałe 437–487 tys. THB / rok (zależnie od dzierżawy gruntu)', 'Koszty zmienne 10,5% przychodu (fundusz remontowy + OTA)', 'Zarządzanie (operator) 25% zysku operacyjnego'],
...
const en: SolayaCopy = {
  ...
  roi: {
    ...
    title: '15–19% net return — depending on the villa',
    intro: 'Net figures — after operating costs and the operator fee. Nightly rates match real prices of comparable villas in Plai Laem (Booking.com listings). Returns differ between villa groups, driven by position, bedroom count and price. A projection, not a guarantee.',
    revenueLabel: 'Gross revenue / year',
    netLabel: 'Net profit / year',
    rateLabel: 'Net return',
    rateNote: 'midpoint of base–upper range',
    villas: [
      { name: 'Villas 1–3 · 3 bedrooms', revenue: '4.5–4.9 M THB', net: '2.7–3.0 M THB', rate: '16.2%' },
      { name: 'Villas 4–9 · 2 bedrooms', revenue: '3.5–3.8 M THB', net: '2.0–2.2 M THB', rate: '15.2%' },
      { name: 'Villas 10–15 · 2–3 bed + rooftop', revenue: '3.4–3.8 M THB', net: '2.0–2.2 M THB', rate: '16.1%' },
      { name: 'Villas 16–19 · 3 bed + rooftop', revenue: '3.9–4.3 M THB', net: '2.3–2.5 M THB', rate: '18.8%' },
    ],
    ...
    costs: ['Fixed costs 437–487k THB / year (depending on the land lease)', 'Variable costs 10.5% of revenue (renovation fund + OTA)', 'Management (operator) 25% of operating profit'],
...
const de: SolayaCopy = {
  ...
  villas: {
    ...
    types: [
      { key: '2bed', name: 'Villa mit 2 Schlafzimmern', area: '194–249 m² Nutzfläche', tagline: 'Kompakter Luxus', desc: 'Für die Premium-Vermietung konzipiert: offener Wohnbereich mit Küche und Essplatz, zwei Schlafzimmer mit Bädern, privater Pool und großzügige Terrasse. Ideal für Paare und kleine Familien — und am leichtesten zu vermieten.', features: ['Offener Wohnbereich', 'Zwei Schlafzimmer mit Bad', 'Privater Pool & Terrasse'] },
      { key: '3bed', name: 'Villa mit 3 Schlafzimmern', area: '282–342 m² Nutzfläche', tagline: 'Platz für Familie und Gäste', desc: 'Offenes Wohnzimmer mit Kücheninsel und Essplatz, drei Schlafzimmer mit Bädern, Pool und Terrasse im Resort-Standard, zum Garten hin geöffnet. Hohe Vermietungsattraktivität im Familien- und Gruppensegment.', features: ['Wohnzimmer mit Kücheninsel', 'Drei Schlafzimmer mit Bad', 'Resort-Terrasse & Pool'] },
      { key: 'terrace', name: 'Villa mit 3 Schlafzimmern + Dachterrasse', area: '279–315 m² Nutzfläche', tagline: 'Das Flaggschiff', desc: 'Alles, was die 3-Schlafzimmer-Villa bietet, plus eine private Dachterrasse mit Lounge und Essbereich unter einer Pergola und Panorama-Meerblick. Sonnenuntergänge auf dem eigenen Dach sind das Erlebnis, für das Gäste wiederkommen.', features: ['Private Dachterrasse', 'Lounge & Essbereich unter Pergola', 'Panorama-Meerblick'] },
    ],
  },
  finishing: {
  ...
  roi: {
    eyebrow: 'Rendite',
    title: '15–19% Nettorendite — je nach Villa',
    intro: 'Netto-Werte — nach Betriebskosten und Betreibervergütung. Die Nächtigungspreise entsprechen realen Preisen vergleichbarer Villen in Plai Laem (Booking.com). Die Rendite unterscheidet sich je nach Villengruppe — abhängig von Lage, Schlafzimmerzahl und Preis. Prognose, keine Garantie.',
    revenueLabel: 'Bruttoeinnahmen / Jahr',
    netLabel: 'Nettogewinn / Jahr',
    rateLabel: 'Netto-Rendite',
    rateNote: 'Mittelwert aus Basis–oberem Szenario',
    villas: [
      { name: 'Villen 1–3 · 3 Schlafzimmer', revenue: '4.5–4.9 Mio. THB', net: '2.7–3.0 Mio. THB', rate: '16.2%' },
      { name: 'Villen 4–9 · 2 Schlafzimmer', revenue: '3.5–3.8 Mio. THB', net: '2.0–2.2 Mio. THB', rate: '15.2%' },
      { name: 'Villen 10–15 · 2–3 Schlafz. + Dachterrasse', revenue: '3.4–3.8 Mio. THB', net: '2.0–2.2 Mio. THB', rate: '16.1%' },
      { name: 'Villen 16–19 · 3 Schlafz. + Dachterrasse', revenue: '3.9–4.3 Mio. THB', net: '2.3–2.5 Mio. THB', rate: '18.8%' },
    ],
    ...
    costs: ['Fixkosten 437–487 Tsd. THB / Jahr (je nach Grundstückspacht)', 'Variable Kosten 10,5% des Umsatzes (Renovierungsfonds + OTA)', 'Management (Betreiber) 25% des Betriebsgewinns'],
